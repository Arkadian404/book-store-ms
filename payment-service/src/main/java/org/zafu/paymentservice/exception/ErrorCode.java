package org.zafu.paymentservice.exception;
...
public enum ErrorCode {
    ...
    PAYMENT_FAILED(789, "Payment failed please try again", HttpStatus.BAD_REQUEST),
    ORDER_NOT_FOUND(258, "Order not found", HttpStatus.BAD_REQUEST);
