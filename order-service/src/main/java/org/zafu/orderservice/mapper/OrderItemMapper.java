...
public interface OrderItemMapper {
    ...
    InternalOrderItemResponse toInternalOrderItemResponse(OrderItem orderItem, @Context BookClient bookClient);
    ...
    @AfterMapping
    default void fillBookInfoInternal(@MappingTarget InternalOrderItemResponse request, OrderItem orderItem, @Context BookClient bookClient){
        BookResponse bookResponse = bookClient.getBookById(orderItem.getBookId())
                .orElseThrow(() -> new RuntimeException("Book not found"))
                .getResult();
        request.setBookTitle(bookResponse.getTitle());
